...
<h2><?php echo GxHtml::encode($model->getRelationLabel('cities')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->cities as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('cities/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
