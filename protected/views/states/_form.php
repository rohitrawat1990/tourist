...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<div class="row">
		<div class="rowLabel"><?php echo $form->labelEx($model,'state_name'); ?>
</div>
		<div class="rowControl"><?php echo $form->textField($model, 'state_name', array('maxlength' => 100)); ?>
		...
		<?php echo $form->error($model,'updated_by'); ?>
		 ...
		 <div class="row"><div class="rowLabel"><label><?php echo GxHtml::encode($model->getRelationLabel('cities:')); ?>
                    </label></div>
             <div class="rowControl">	<?php echo $form->checkBoxList($model, 'cities', GxHtml::encodeEx(GxHtml::listDataEx(Cities::model()->findAllAttributes(null, true)), false, true)); ?>
                 </div>
              </div>
